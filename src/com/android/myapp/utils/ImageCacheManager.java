...
public class ImageCacheManager{
	...
	/** caoshiyu add
	 * 	Get the imgelistener for some imgeview
	 * @param imageView
	 * 		the imageview
	 * @param defaultIconId
	 * 		default icon of imageview
	 * @param errorIconId
	 *      iconId when some error happen
	 */
	public ImageListener getImageListener(ImageView imageView, int defaultIconId, int errorIconId){
		return mImageLoader.getImageListener(imageView, defaultIconId, errorIconId);
	}
	/**
	 * @return
